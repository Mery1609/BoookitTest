...
public class APIDay3 {
	...
	public void regionPOSTv1() {
	  ...
	  String requestBody = "{\"region_id\":505,\"region_name\":\"myregion\"}";
...
>>>>>>> a69feb62c851ee1f471ff0d4266f9d68768a2891
	  ...
	  //verify region id
<<<<<<< HEAD
	  assertEquals(json.getInt("region_id"), 505);
  ...
  public void regionPOSTv2() {
    ...
    //verify region id
    assertEquals(json.getInt("region_id"), 506);
  ...
  public void regionPOSTv3() {
    ...
    //verify region id
    assertEquals(json.getInt("region_id"), 507);
  ...
  @Test
  public void countryPOST() {    //creating for the first time
	  
	  Country country = new Country();
	  
	  country.setCountry_id("AAA");
	  country.setCountry_name("Cyber");
	  ...
	  //verify regular body and response body
  ...
  @Test
  public void countryPUT() {    //updating the existing input
	  
	  Country country = new Country();
	  
	  country.setCountry_id("a");
